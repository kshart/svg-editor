...
import PathMenuItem from '../basic/PathMenuItem'
import UseMenuItem from '../basic/UseMenuItem'
...
Vue.component('svg-path-menu-item', PathMenuItem)
Vue.component('svg-use-menu-item', UseMenuItem)
