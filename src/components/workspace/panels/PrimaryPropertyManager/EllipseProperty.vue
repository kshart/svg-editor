<template>
  <div class="body">
    <div class="group">
      <div class="block">
        <p class="block-title">cx</p>
        <input-number v-model="cx" />
      </div>
      <div class="block">
        <p class="block-title">cy</p>
        <input-number v-model="cy" />
      </div>
      <div class="block">
        <p class="block-title">rx</p>
        <input-number v-model="rx" />
      </div>
      <div class="block">
        <p class="block-title">ry</p>
        <input-number v-model="ry" />
      </div>
    </div>
  </div>
</template>
